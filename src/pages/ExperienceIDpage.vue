...
function goToBookingPage(targetId: number) {
  router.push({ name: "booking", params: { id: targetId }, query: { ...route.query } });
}
...
const { title, image, location, longDescription, price, tags } =
  selectedExperience ?? { title: "", image: "", location: "", longDescription: "", price: 0, tags:[] };
</script>
<template>
